...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Recherche dans la base de données Clients - Pesage</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-offset-4 col-lg-4">            
                    <form class="form-horizontal" method="post" action="rechercheClients.traitement.php?idS=<?php echo $codeU_Session; ?>">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" style="text-transform: uppercase" type="text" name="codeC" id="codeC" autocomplete="off" pattern="^[0-9a-zA-Z\s]{0,10}$">
                            </div>
