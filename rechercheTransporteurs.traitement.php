...
// gestion boutons annuler/valider
    if(isset($_POST["annuler"])){
        ...
        if((!empty($_POST["codeT"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeT"]) && !empty($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeT"]) && isset($_POST["contact"]) && !empty($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeT"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && !empty($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeT"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && !empty($_POST["ville"])))
        {    
            $code = $_POST["codeT"];
            ...
            try{
                ...
                $req = $pdo->query("SELECT * FROM transporteurs WHERE CodeTransporteur LIKE '" .$code. "%' && RaisonSociale LIKE '" .$raisonSociale. "%' && Contact LIKE '" .$contact. "%' && CodePostal LIKE '" .$cp. "%' && Ville LIKE '" .$ville. "%'");
                $req->execute();
                
                $nvTab = array();
                while ($row = $req->fetch()){
                    $nvTab[] = array(
                            'CodeTransporteur' => $row["CodeTransporteur"],
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">            
                    <table id='recherche' border="1">
                        ...
                        <tr>
                            <td><a href="gestionTransporteurs.php?codeTrans=<?php echo $val['CodeTransporteur'];?>&idS=<?php echo $codeU_Session; ?>"><?php echo $val['CodeTransporteur']; ?></a></td>
            ...
            <div class="row">
                ...
                <?php if($nvTab == array()){ ?>
                    <div style="text-align: center; font-style: oblique; font-size: 16px;" class="col-lg-offset-2 col-lg-8">            
                        <br>
                        <?php
                        ...
                        <div class="col-lg-12">                        
                            <div id="bouton" class="well col-lg-offset-2 col-lg-3" >  
                                <a  href="rechercheTransporteurs.php?idS=<?php echo $codeU_Session; ?>">Nouvelle recherche</a>
                            </div>
                            <div id='bouton' class="well col-lg-offset-2 col-lg-3">
                                <a  href="accueil.php?idS=<?php echo $codeU_Session; ?>">Annuler</a>                         
                            </div> 
