...
// gestion boutons annuler/valider
    if(isset($_POST["annuler"])){
        ...
        if((!empty($_POST["codeS"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeS"]) && !empty($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeS"]) && isset($_POST["contact"]) && !empty($_POST["raiSoc"]) && isset($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeS"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && !empty($_POST["cp"]) && isset($_POST["ville"])) ||
        (isset($_POST["codeS"]) && isset($_POST["contact"]) && isset($_POST["raiSoc"]) && isset($_POST["cp"]) && !empty($_POST["ville"])))
        {    
            $code = $_POST["codeS"];
            ...
            try{
                ...
                $req = $pdo->query("SELECT * FROM site WHERE CodeSite LIKE '" .$code. "%' && RaisonSociale LIKE '" .$raisonSociale. "%' && Contact LIKE '" .$contact. "%' && CodePostal LIKE '" .$cp. "%' && Ville LIKE '" .$ville. "%'");
                $req->execute();
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">            
                    <table id='recherche' border="1">
                        ...
                        <tr>
                            <td><a href="gestionSites.php?codeSite=<?php echo $val['CodeSite'];?>&idS=<?php echo $codeU_Session; ?>"><?php echo $val['CodeSite']; ?></a></td>
                    ...
                    <div style="text-align: center; font-style: oblique; font-size: 16px;" class="col-lg-8 col-lg-offset-2">            
                        ...
                        <div class="col-lg-12">                        
                            <div id="bouton" class="well col-lg-offset-2 col-lg-3" >  
                                <a  href="rechercheSites.php?idS=<?php echo $codeU_Session; ?>">Nouvelle recherche</a>
                            </div>
                            <div id="bouton" class="well col-lg-offset-2 col-lg-3">
                                <a  href="accueil.php?idS=<?php echo $codeU_Session; ?>">Annuler</a>                         
                            </div>                          
