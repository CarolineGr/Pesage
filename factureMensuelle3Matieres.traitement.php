<?php session_start();
    ...
    // gestion bouton valider
        ...
        if(isset($_POST["codematiere3"])){
            $codematiere3 = $_POST["codematiere3"];
            $_SESSION["codeMat3"] = $codematiere3;
            $dateTimeD = $_SESSION["dateTimeD"];
            $dateTimeF = $_SESSION["dateTimeF"];
            
            // requete bdd matières
            $req = $pdo->query('SELECT * FROM matieres WHERE CodeMatiere="' .$codematiere3.'";');        
            $bdd = $req->fetch();
            ...
            <div class="row">
                <div class="col-lg-offset-3">
                    <table id="search" border="1">                        
                        <caption>** Résultat de la recherche pour ** <br><span class="blue">** <?php echo $_SESSION["client"] ?> **</span><br><span class="violet"> ** <?php echo $matiere3; ?> **</span></caption>
                            <thead>
                                <tr>
                                    <th>ID pesée</th>
                                    <th>Date</th>
                            ...
                            <tbody>
                                ...
                                $req = $pdo->prepare("SELECT * FROM `historiquepesees` WHERE `DateEntree` BETWEEN '" .$_SESSION["dateTimeD"]. "' AND '" .$_SESSION["dateTimeF"]. "' AND CodeClient = '" .$codeC. "' AND CodeMatiere = '" .$codematiere3. "';");
                                $req->execute();
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $poids; ?></td> <?php $_SESSION["poidsT3"] += $poids; ?> <!-- calcul du poids total par matière-->
                                    <td><?php echo $prix; ?></td> <?php $_SESSION["prixT3"] += $prix; ?> <!-- calcul du prix total par matière  -->
                                </tr> 
                                <?php } ?>
                        </tbody>                        
                    </table>
                ...
                <div class="row">
                    <div id="bouton" class="well col-lg-offset-3 col-lg-2" style="text-align: center">
                        <a href="javascript:
