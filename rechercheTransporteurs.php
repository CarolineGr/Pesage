...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Recherche dans la base de données Transporteur - Pesage</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-offset-4 col-lg-4">            
                    <form class="form-horizontal" method="post" action="rechercheTransporteurs.traitement.php?idS=<?php echo $codeU_Session; ?>">
                        <fieldset>
                            <legend>Recherche d'un transporteur</legend>
                            <br>
                            
                            <div class="form-group">
                                <label for="codeT">Code transporteur</label>
                                <input class="form-control" style="text-transform: uppercase" type="text" name="codeT" id="codeT" autocomplete="off" pattern="^[0-9a-zA-Z\s]{0,10}$">
                            </div>
