...
<html>
   <head>
        <meta charset="UTF-8">
        <title>Transporteur - Pesage</title>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <form class="form-horizontal" role="form" method="post" action="#">
                        <fieldset>
                        <legend>Création d'un transporteur</legend>
        
                        <div class="form-group col-lg-6">
                            <label style="text-align: left" class="col-lg-5 control-label" for="codeT">Code transporteur</label>
                            <div class="col-lg-7">
                                <input class="form-control" style="text-transform: uppercase" type="text" name="codeT" id="codeT" pattern="^[0-9a-zA-Z\s]{2,10}$" autocomplete="off" >
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            <label style="text-align: left" class="col-lg-5 control-label" for="adresse1">Adresse 1</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group col-lg-6">
                            <label style="text-align: left" class="col-lg-5 control-label" for="adresse3">Adresse 3</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group col-lg-6">
                            <label style="text-align: left" class="col-lg-5 control-label" for="ville">Ville</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-7">
                                <input class="form-control" style="text-transform: uppercase" type="text" name="pays" id="pays" pattern="^[-çéèùa-zA-Z\s]{2,30}$" autocomplete="off" >
                            </div>
                        </div>                    
                        <div class="form-group col-lg-6">
                            <label style="text-align: left" class="col-lg-5 control-label" for="tel">Téléphone</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group col-lg-6">
                           <label style="text-align: left" class="col-lg-5 control-label" for="contact">Contact</label>
                            <div class="col-lg-7">
...
// gestion bouton annuler
    if(isset($_POST["annuler"])){
        if(($_POST["codeT"] != "") || ($_POST["raiSoc"] != "") || ($_POST["adresse1"] != "") || ($_POST["adresse2"] != "") || ($_POST["adresse3"] != "") || ($_POST["cp"] != "") || ($_POST["ville"] != "") || ($_POST["pays"] != "") || ($_POST["tel"] != "") || ($_POST["email"] != "")  || ($_POST["contact"] != "")){
            ?>
...
// gestion bouton valider        
        ...
        // vérification que le code transporteur n'exite pas déjà dans la bdd 
        $pdo = gestionnaireDeConnexion();
        $reqVerif = $pdo->prepare("SELECT CodeTransporteur FROM transporteurs WHERE CodeTransporteur='" .$_POST["codeT"]. "';");
        $reqVerif->execute();
        $verif = $reqVerif->rowCount();
        if($verif === 1){
            ?><script language="javascript">
                alert("Code transporteur déjà utilisé...");
                history.back();
            </script>
            <?php 
            exit();
        ...
        if(!empty($_POST["codeT"]) && !empty($_POST["raiSoc"]) && !empty($_POST["adresse1"])&& isset($_POST["adresse2"])&& isset($_POST["adresse3"])&& !empty($_POST["cp"])&& !empty($_POST["ville"])&& !empty($_POST["pays"])&& !empty($_POST["tel"])&& isset($_POST["email"])&& !empty($_POST["contact"])){
            // récupération des données, modification de la casse
            $codeTrans = sansAccents($_POST["codeT"]);
            $codeTrans = mb_strtoupper($codeTrans);
            ...
            try{            
                ...
                $sql = "INSERT INTO `pesage`.`transporteurs` (`CodeTransporteur`, `RaisonSociale`, `Adresse1`, `Adresse2`, `Adresse3`, `CodePostal`, `Ville`, `Pays`, `Telephone`, `Mail`, `Contact`) VALUES ('" . $codeTrans . "', '" . $raisonSociale . "', '" . $adresse1 . "', '" . $adresse2 . "', '" . $adresse3 . "', '" . $cp . "', '" . $ville . "', '" . $pays . "', '" . $tel . "', '" . $email . "', '" . $contact . "');";
                $conn->exec($sql);
            }
            ...
            ?><script language="javascript">
                alert("Nouveau transporteur enregistré avec succès !");
                window.location.href='accueil.php?idS=<?php echo $codeU_Session;?>';
            </script><?php 
            // END - script popup
