        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-offset-1 col-lg-10 ">
                    <form class="form-horizontal" role="form" method="POST" action="factureMensuelle2Matieres.traitement.php?idS=<?php echo $codeU_Session;?>">
                        <div class=" col-lg-offset-1 col-lg-10">
                            <fieldset>
                                ...
                                <div class="col-lg-offset-3 col-lg-10">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-2 col-lg-pull-1">
                                          <select type="text" style="text-transform: uppercase" class="form-control" name="codematiere2">
                                                <?php
                                                ...
                                                // Boucle d'affichage
                                                    ...
                                                    <?php if(($_SESSION["codeMat1"] != $matiere)){echo $matiere;} ?>
                                                    </option>                                    
                                                <?php } 
                                                ?>
                                            </select>
