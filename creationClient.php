        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <form class="form-horizontal" role="form" method="post" action="creationClient.traitement.php?idS=<?php echo $codeU_Session;?>">
                        <fieldset>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-7">
                              <input class="form-control" style="text-transform: uppercase" type="text" name="codeC" id="codeC" pattern="^[0-9a-zA-Z\s]{2,10}$" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-7">
                            <input class="form-control" style="text-transform: uppercase" type="text" name="adresse3" id="adresse3" placeholder="facultatif" pattern="^[-,'°çÈÉÊËÔÖÙÛÜÀÂÄÌÍÎÏéïîöôàêâüûèù0-9a-zA-Z\s]{0,30}$" autocomplete="off" >
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-7">
                            <input class="form-control" style="text-transform: uppercase" type="text" name="pays" id="pays" pattern="^[-'çÈÉÊËÔÖÙÛÜÀÂÄÌÍÎÏéïîöôàêäâüûèùa-zA-Z\s]{2,30}$" autocomplete="off" >
                            </div>
                        </div>                    
                        <div class="form-group col-lg-6">
